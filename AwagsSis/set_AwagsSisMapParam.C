...
void set_AwagsSisMapParam()
{
  ...
  param1->fChannel[0][0] = 1;
  param1->fChannel[0][1] = 16;
  param1->fChannel[0][2] = 15;
  param1->fChannel[0][3] = 14;
  param1->fChannel[0][4] = 13;
  param1->fChannel[0][5] = 12;
  param1->fChannel[0][6] = 11;
  param1->fChannel[0][7] = 10;
  param1->fChannel[0][8] = 9;
  param1->fChannel[0][9] = 6;
  param1->fChannel[0][10] = 7;
  param1->fChannel[0][11] = 8;
  param1->fChannel[0][12] = 5;
  param1->fChannel[0][13] = 4;
  param1->fChannel[0][14] = 3;
  param1->fChannel[0][15] = 2;
  param1->fChannel[0][16] = 1;
  param1->fChannel[0][17] = 12;
  param1->fChannel[0][18] = 16;
  param1->fChannel[0][19] = 15;
  param1->fChannel[0][20] = 14;
  param1->fChannel[0][21] = 13;
  param1->fChannel[0][22] = 2;
  param1->fChannel[0][23] = 11;
  param1->fChannel[0][24] = 4;
  param1->fChannel[0][25] = 9;
  param1->fChannel[0][26] = 8;
  param1->fChannel[0][27] = 7;
  param1->fChannel[0][28] = 6;
  param1->fChannel[0][29] = 5;
  param1->fChannel[0][30] = 10;
  param1->fChannel[0][31] = 3;
