...
//***********************************************************
TAwagsSisParam::TAwagsSisParam() : TGo4Parameter("Parameter")
{
  frP1=0;
  frP2=0;
  fiNum=0;
...
//-----------------------------------------------------------
Int_t TAwagsSisParam::PrintParameter(Text_t * n, Int_t){
  return 0;
...
//-----------------------------------------------------------
Bool_t TAwagsSisParam::UpdateFrom(TGo4Parameter *pp){
  if(pp->InheritsFrom("TAwagsSisParam"))
  {
    TAwagsSisParam * from;
    from = (TAwagsSisParam *) pp;
    cout << "**** TAwagsSisParam " << GetName() << " updated from auto save file" << endl;
    fill=from->fill;
    frP1=from->frP1;
    frP2=from->frP2;
    fiNum=from->fiNum;
