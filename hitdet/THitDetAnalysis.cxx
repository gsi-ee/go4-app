...
//***********************************************************
THitDetAnalysis::THitDetAnalysis()
{
}
//***********************************************************

// this constructor is called by go4analysis executable
THitDetAnalysis::THitDetAnalysis(int argc, char** argv) :
   TGo4Analysis(argc, argv)
{
   cout << "**** Create THitDetAnalysis name: " << argv[0] << endl;
   ...
   factory->DefEventProcessor("HitDetRawProc","THitDetRawProc");// object name, class name
   factory->DefOutputEvent("HitDetRawEvent","THitDetRawEvent"); // object name, class name
...
//   factory2->DefEventProcessor("HitDetProfileProc","THitDetProfileProc");// object name, class name
//   factory2->DefOutputEvent("HitDetProfileEvent","THitDetProfileEvent"); // object name, class name
//   factory2->DefInputEvent("HitDetRawEvent","THitDetRawEvent"); // object name, class name
//
//
...
//     AddAnalysisStep(step2);
   ...
   // DefineServerPasswords("VupromHitDetadmin", "VupromHitDetctrl", "VupromHitDetview");
...
THitDetAnalysis::~THitDetAnalysis()
{
   cout << "**** THitDetAnalysis: Delete instance" << endl;
}
