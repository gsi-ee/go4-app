...
//***********************************************************
TGemCSAMapParam::~TGemCSAMapParam()
{
}
//***********************************************************
...
//-----------------------------------------------------------
Int_t TGemCSAMapParam::PrintParameter(Text_t * n, Int_t){
  return 0;
// TODO JAM 2019

}
//-----------------------------------------------------------
Bool_t TGemCSAMapParam::UpdateFrom(TGo4Parameter *pp){
  if(pp->InheritsFrom("TGemCSAMapParam"))
  {
