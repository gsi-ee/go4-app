...
//-----------------------------------------------------------
Int_t TGemCSABasicParam::PrintParameter(Text_t * n, Int_t){
  return 0;
...
//-----------------------------------------------------------
Bool_t TGemCSABasicParam::UpdateFrom(TGo4Parameter *pp){
  if(pp->InheritsFrom("TGemCSABasicParam"))
  {
    TGemCSABasicParam * from;
    from = (TGemCSABasicParam *) pp;
    cout << "**** TGemCSABasicParam " << GetName() << " updated from auto save file" << endl;
    fill=from->fill;
    frP1=from->frP1;
    frP2=from->frP2;
    fiNum=from->fiNum;
